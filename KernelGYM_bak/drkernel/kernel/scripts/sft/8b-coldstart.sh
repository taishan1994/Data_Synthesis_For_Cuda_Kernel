...
HDFS_LOG_PATH="/nfs/FM/gongoubo/KernelGLM/sft/logs"  # you need to set your own log path
HDFS_CHECKPOINT_PATH="./checkpoints/Qwen3-8B-test"  # you need to set your own checkpoint path
HDFS_MODEL_PATH="/nfs/FM/gongoubo/checkpoints/Qwen/"  # you need to set your own model path
...
DATASET_NAME=glm5-coldstart
# TRAIN_FILE_NAME=drkernel-glm5-results-v7
# VAL_FILE_NAME=drkernel-glm5-results-v7
TRAIN_FILE_NAME=synthetic_think_3turn_x100
VAL_FILE_NAME=synthetic_think_3turn_x100
...
LEARNING_RATE=2e-5
SP_SIZE=4
# TRAIN_DATA_PATH="/nfs/FM/gongoubo/cuda_kernel/glm5-coldstart/drkernel-glm5-results-v7.parquet" # you need to set your own training data path
TRAIN_DATA_PATH="/nfs/FM/gongoubo/cuda_kernel/synthetic-think/synthetic_think_3turn_x100.parquet"
