...
class ActorConfig(BaseConfig):
    ...
    entropy_clip_rate: float = 0.0
    loss_scale_factor: float = 1.0
    extreme_risk_prob_threshold: Optional[float] = None
    use_gspo: bool = False
...
class FSDPActorConfig(ActorConfig):
    ...
    Args:
        ...
        compute_sum_pi_squared (bool): Whether to compute sum of pi squared for variance proxy metrics and optimal baseline.
        sum_pi_squared_checkpointing (bool): Whether to use gradient checkpointing for sum_pi_squared computation.
    ...
    compute_sum_pi_squared: bool = True  # Default enabled for variance proxy metrics
    sum_pi_squared_checkpointing: bool = False  # Gradient checkpointing for sum_pi_squared
